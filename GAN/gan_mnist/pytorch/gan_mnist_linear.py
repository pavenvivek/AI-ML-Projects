...
class Generator(nn.Module):
    def __init__(self):
        ...
        self.dense2 = nn.LazyLinear(512)
        self.dense3 = nn.LazyLinear(784)
...
class Discriminator(nn.Module):
    def __init__(self):
        ...
        self.dense2 = nn.LazyLinear(256)
        self.dense3 = nn.LazyLinear(1)
...
print (f"predictions shape 1 : {predictions.shape}")

predictions = torch.reshape(predictions, (16, 1, 28, 28))

print (f"predictions shape 2 : {predictions.shape}")
