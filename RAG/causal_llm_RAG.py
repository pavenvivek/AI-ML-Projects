...
vocab = train_word_piece(raw_train_ds, "vocab_causal_llm_local.txt")
...
def get_data():
    ...
    return tokenizer, start_packer, train_ds, val_ds
...
if __name__ == "__main__":
    ...
    tokenizer, start_packer, train_ds, val_ds = get_data()
    ...
    model.save("causal_llm_RAG.keras")
    #model = keras.models.load_model("causal_llm_RAG.keras", compile=False)
